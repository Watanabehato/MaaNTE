...
fn main() {
    if maante_lib::commands::system::has_help_flag() {
        print!("{}", maante_lib::commands::system::get_cli_help_text());
        return;
    }
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        if !cfg!(debug_assertions) && !maante_lib::commands::system::is_elevated() {
