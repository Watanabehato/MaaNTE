    ...
    if wait_for_exit {
        ...
        loop {
            ...
            if stop_requested {
                ...
                return Err("MAANTE_PRE_ACTION_CANCELLED".to_string());
            }
...
pub fn get_cli_help_text() -> String {
    let exe_name = std::env::current_exe()
        ...
        .unwrap_or_else(|| "maante".to_string());
